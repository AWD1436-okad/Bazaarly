...
- Replaced the placeholder `B` branding with the provided Profit Planet logo asset in the main app brand areas
...
Profit Planet is now v1-ready pending:
...
- polished the shared Profit Planet logo display so the uploaded logo fills the brand mark more cleanly
