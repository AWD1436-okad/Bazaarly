...
const regionalOverrides: Partial<Record<SupportedCurrencyCode, Record<string, number>>> = {
  AUD: {
    ...
    "Basic Abaya": 49.99,
    "Premium Abaya": 79.99,
    "Embroidered Abaya": 94.99,
    "Formal Sherwani": 109.99,
    Water: 0.85,
    Bisht: 54.99,
    "Premium Bisht": 74.99,
    Phone: 799,
...
> = {
  AUD: {
    ...
    CLOTHING: [8.99, 190],
    MUSLIM_CLOTHING_AND_APPAREL: [8.99, 190],
  ...
  USD: {
    ...
    CLOTHING: [6.99, 140],
    MUSLIM_CLOTHING_AND_APPAREL: [6.99, 140],
  ...
  GBP: {
    ...
    CLOTHING: [5, 130],
    MUSLIM_CLOTHING_AND_APPAREL: [5, 130],
  ...
  EUR: {
    ...
    CLOTHING: [6, 150],
    MUSLIM_CLOTHING_AND_APPAREL: [6, 150],
  ...
  PKR: {
    ...
    CLOTHING: [600, 26000],
    MUSLIM_CLOTHING_AND_APPAREL: [600, 26000],
  ...
  INR: {
    ...
    CLOTHING: [250, 14000],
    MUSLIM_CLOTHING_AND_APPAREL: [250, 14000],
  ...
  AED: {
    ...
    CLOTHING: [18, 450],
    MUSLIM_CLOTHING_AND_APPAREL: [18, 450],
  ...
  SAR: {
    ...
    CLEANING_AND_PERSONAL_CARE: [4, 45],
    CLOTHING: [18, 430],
    MUSLIM_CLOTHING_AND_APPAREL: [18, 430],
    HOME_AND_STORAGE: [15, 180],
    ELECTRONICS: [20, 3900],
    SCHOOL_AND_MISC: [2, 80],
  },
  TRY: {
    ...
    CLOTHING: [250, 12000],
    MUSLIM_CLOTHING_AND_APPAREL: [250, 12000],
...
function makeMultiplierProfile(multiplier: number) {
  return {
    ...
    CLOTHING: multiplier,
    MUSLIM_CLOTHING_AND_APPAREL: multiplier,
